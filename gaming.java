...
class gaming
{
    ...
    static void meth()throws Exception
    {
        ...
        gaming I=new gaming();
        System.out.println("****************************************************");
        System.out.println("you have chosen gaming consoles");
        System.out.println(" a wide variety of gaming consoles are available");
        System.out.println("curently we have these gaming consoles");
        System.out.println("1] sony ps3");
        System.out.println("2] sony psp");
        System.out.println("3] sony ps2");
        System.out.println("4] XBox 360");
        System.out.println("5] nintendo wii");
        System.out.println("***************************************************");
        ...
        if(n==1)
        {System.out.println("you have chosen sony ps3,good choice");
            System.out.println("the price is=22990");
        ...
        if(n==2){System.out.println("you have chosen  sony psp ,classy");
            System.out.println("the price is=6990");
            System.out.println("would you like to buy");
            String c1="yes";
            String c2="no";
        ...
        if(n==3)
        {System.out.println("you have chosen  sony ps2,excellent choice");
            System.out.println("the price is=9880");
            System.out.println("would you like to buy");
            String d1="yes";
            String d2="no";
        ...
        if(n==4)
        {System.out.println("you have chosen Xbox 360,an highly efficient gaming console ");
            System.out.println("the price is=24990");
            System.out.println("would you like to buy");
            String e1="yes";
            String e2="no";
        ...
        if(n==5)
        {System.out.println("you have chosen nintendo wii,not a bad choice");
            System.out.println("the price is=15990");
            System.out.println("would you like to buy");
            String f1="yes";
            String f2="no";
