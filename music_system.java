...
class music_system
{
    ...
    static void meth()throws Exception
    {
        ...
        music_system C=new music_system();
        System.out.println("****************************************************");
        System.out.println("you have chosen music system");
        System.out.println(" a wide variety of music systems are available");
        System.out.println("curently we have these music systems");
        System.out.println("1] SONY MHD 310");
        System.out.println("2] zebronic stem690");
        System.out.println("3] transcend mp300 4GB");
        System.out.println("4] philips go gear Ra 4GB");
        System.out.println("5] Transcend MP340 8GB");
        System.out.println("***************************************************");
        ...
        if(n==1)
        {System.out.println("you have chosen SONY MHD 310 ,good choice");
        ...
        if(n==2)
        {System.out.println("you have chosen zebronic stem690 ,classy");
        ...
        if(n==3)
        {System.out.println("you have chosen transcend 300 4GB ,excellent choice");
        ...
        if(n==4)
        {System.out.println("you have chosen philips go gearRa 4GB,an highly efficient television");
        ...
        if(n==5)
        {System.out.println("you have chosen Transcend mp340 8GB,not a bad choice");
